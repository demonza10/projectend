...
import 'package:queuenbuapp/service/add_item_activity_service.dart';
import 'package:queuenbuapp/service/logger_service.dart';

class AddItemActivity extends StatefulWidget {
  AddItemActivity({Key key}) : super(key: key);

  @override
  _AddItemActivityState createState() => _AddItemActivityState();
}
